...
# awk
#
javap -v /Volumes/git/github/java_dataflow_dependency_csv/java_csv_data_dependency/target/classes/com/rohidekar/analyzed/Simple* | tee /tmp/class.txt | awk -f ~/bin/awk_java_instructions.awk | grep -v unimple
